  ...
  return (
    <button
      ...
      className={cn(
        ...
        cn('focus-visible:ring-2 focus-visible:ring-bd-orange focus-visible:ring-offset-2', light ? 'focus-visible:ring-offset-background' : 'focus-visible:ring-offset-[#020617]'),
        'motion-reduce:transition-none sm:bottom-6 sm:right-6 sm:min-w-[238px]',
        open
          ? 'border-bd-orange bg-bd-orange text-slate-950'
          : light
            ? 'border-bd-orange/70 bg-sidebar text-sidebar-foreground hover:-translate-y-0.5 hover:border-bd-orange hover:bg-sidebar-accent'
    ...
    >
      <span
        className={cn(
          ...
          open ? 'border-slate-950/15 bg-slate-950/10' : light ? 'border-bd-orange/50 bg-sidebar-accent' : 'border-bd-orange/50 bg-slate-950'
        )}
      >
      ...
      <span className="grid min-w-0 text-left leading-tight">
        ...
        <span className={cn('mt-0.5 text-[11px] font-medium', open ? 'text-slate-950/70' : light ? 'text-muted-foreground' : 'text-slate-400')}>
