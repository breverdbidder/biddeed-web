...
export default function AuctionFilters({
  ...
  const selectClass = 'px-3 py-1.5 min-h-11 md:min-h-0 min-w-0 max-w-full text-sm bg-card dark:bg-card border border-input dark:border-input rounded-md text-foreground dark:text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30'
